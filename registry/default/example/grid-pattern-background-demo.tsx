import GridPatternBackground from "@/registry/default/ui-canvas/grid-pattern-background";

export default function GridPatternBackgroundDemo() {
  return (
    <div className="z-30 flex w-full flex-col gap-4 dark:bg-black">
      <div className="relative h-[400px] rounded-lg bg-gradient-to-br from-violet-500/20 to-purple-500/20">
      ...
      <div className="relative h-[400px] rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20">
        <GridPatternBackground
          gridType="lines"
          gridSize={32}
          opacity={0.4}
