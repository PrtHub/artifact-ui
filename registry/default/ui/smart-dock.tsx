...
const variantStyles: Record<DockVariant, string> = {
  ...
  wooden:
    "bg-gradient-to-t from-amber-900/30 to-amber-800/20 dark:from-amber-950/30 dark:to-amber-900/20 backdrop-blur-sm border border-amber-800/30 dark:border-amber-700/30 shadow-md",
  metallic:
    "bg-gradient-to-t from-slate-400/30 to-slate-300/20 dark:from-slate-600/30 dark:to-slate-500/20 backdrop-blur-lg border border-slate-300/50 dark:border-slate-400/30 shadow-lg",
  ...
  chalk:
    "bg-slate-50/90 dark:bg-slate-900/90 border-2 border-dashed border-slate-300 dark:border-slate-700 shadow-sm",
  paper:
    "bg-gradient-to-t from-stone-100/90 to-white/80 dark:from-stone-900/90 dark:to-stone-950/80 border border-stone-200/50 dark:border-stone-800/50",
  canvas:
    "bg-gradient-to-t from-neutral-100/95 to-neutral-50/90 dark:from-neutral-900/95 dark:to-neutral-950/90 border-2 border-neutral-200/50 dark:border-neutral-800/50",
  frost:
    "bg-gradient-to-t from-blue-100/30 to-blue-50/20 dark:from-blue-900/30 dark:to-blue-950/20 backdrop-blur-xl border border-blue-200/50 dark:border-blue-800/30 shadow-lg shadow-blue-500/10",
  sunset:
    "bg-gradient-to-t from-orange-500/20 via-pink-500/20 to-purple-500/20 dark:from-orange-600/20 dark:via-pink-600/20 dark:to-purple-600/20 backdrop-blur-sm border border-orange-500/30 dark:border-orange-400/30",
  ocean:
    "bg-gradient-to-t from-cyan-500/20 to-blue-500/20 dark:from-cyan-600/20 dark:to-blue-600/20 backdrop-blur-sm border border-cyan-500/30 dark:border-cyan-400/30",
  forest:
    "bg-gradient-to-t from-green-800/20 to-emerald-600/20 dark:from-green-900/20 dark:to-emerald-800/20 backdrop-blur-sm border border-green-600/30 dark:border-green-500/30",
  desert:
    "bg-gradient-to-t from-yellow-700/20 to-orange-600/20 dark:from-yellow-800/20 dark:to-orange-700/20 backdrop-blur-sm border border-yellow-600/30 dark:border-yellow-500/30",
  cosmic:
    "bg-gradient-to-t from-violet-900/30 via-purple-800/20 to-fuchsia-900/30 dark:from-violet-950/30 dark:via-purple-900/20 dark:to-fuchsia-950/30 backdrop-blur-xl border border-violet-500/30 dark:border-violet-400/30 shadow-lg shadow-violet-500/20",
  cyber:
    "bg-gradient-to-t from-teal-500/20 via-cyan-500/10 to-blue-500/20 dark:from-teal-600/20 dark:via-cyan-600/10 dark:to-blue-600/20 backdrop-blur-lg border border-teal-400/30 dark:border-teal-500/30 shadow-lg shadow-teal-500/20",
};
...
const tooltipVariantStyles: Record<DockVariant, string> = {
  modern:
    "bg-zinc-900/90 border border-zinc-800/50 shadow-lg shadow-zinc-950/20 backdrop-blur-sm",
  glass:
    "bg-white/20 border border-white/30 shadow-xl shadow-white/10 backdrop-blur-xl",
  wooden:
    "bg-gradient-to-t from-amber-950/90 to-amber-900/80 border border-amber-800/50 shadow-lg shadow-amber-950/30",
  metallic:
    "bg-gradient-to-t from-slate-300/90 to-slate-200/80 border border-slate-200/50 shadow-lg shadow-slate-950/20 backdrop-blur-sm",
  neon: "bg-black/80 border-2 border-fuchsia-500/50 shadow-lg shadow-fuchsia-500/20 backdrop-blur-sm animate-pulse",
  chalk:
    "bg-slate-50 border-2 border-dashed border-slate-300/50 shadow-sm backdrop-blur-sm",
  paper:
    "bg-gradient-to-t from-stone-100/95 to-white/90 border border-stone-200/50 shadow-lg backdrop-blur-sm",
  canvas:
    "bg-gradient-to-t from-neutral-100/95 to-neutral-50/90 border-2 border-neutral-200/50 shadow-lg backdrop-blur-sm",
  frost:
    "bg-gradient-to-t from-blue-100/30 to-blue-50/20 border border-blue-200/50 shadow-lg shadow-blue-500/20 backdrop-blur-xl",
  sunset:
    "bg-gradient-to-r from-orange-500/90 via-pink-500/90 to-purple-500/90 border border-orange-500/30 shadow-lg shadow-orange-500/20 backdrop-blur-sm",
  ocean:
    "bg-gradient-to-r from-cyan-600/90 to-blue-600/90 border border-cyan-500/30 shadow-lg shadow-cyan-500/20 backdrop-blur-sm",
  forest:
    "bg-gradient-to-t from-green-900/90 to-emerald-800/90 border border-green-700/30 shadow-lg shadow-green-900/20 backdrop-blur-sm",
  desert:
    "bg-gradient-to-t from-yellow-800/90 to-orange-700/90 border border-yellow-700/30 shadow-lg shadow-yellow-800/20 backdrop-blur-sm",
  cosmic:
    "bg-gradient-to-r from-violet-900/90 via-purple-800/90 to-fuchsia-900/90 border border-violet-500/30 shadow-lg shadow-violet-500/20 backdrop-blur-sm animate-shimmer",
  cyber:
    "bg-gradient-to-r from-teal-500/90 via-cyan-500/90 to-blue-500/90 border border-teal-400/30 shadow-lg shadow-teal-500/20 backdrop-blur-sm",
};
