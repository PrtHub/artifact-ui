      ...
      {members.map((member, index) => (
        ...
        >
          <div className="relative h-full w-full">
            ...
            />
            <motion.div
              className="absolute bottom-0 flex h-full w-full flex-col items-center justify-end bg-gradient-to-t from-[rgba(2,2,46,0.68)] to-transparent p-4 text-2xl text-white"
              initial={false}
              animate={{
